Shader "Ciconia Studio/Shader Painter/MetalRough/Standard Multi Layers" {
	Properties {
		[Header(SP_Multi Layers MetalRough Layer3)] [HideInInspector] _SpecularColor3 ("Specular Color3", Vector) = (1,1,1,0)
		...
		[Header(SP_Multi Layers MetalRough Layer4)] [HideInInspector] _SpecularColor4 ("Specular Color4", Vector) = (1,1,1,0)
		[HideInInspector] _Metallic4 ("Metallic4", Range(0, 2)) = 0.2
		[HideInInspector] _Roughness4 ("Roughness4", Range(0, 2)) = 0.5
		...
		[Header(SP_Multi Layers MetalRough Layer2)] [HideInInspector] _SpecularColor2 ("Specular Color2", Vector) = (1,1,1,0)
